...
const INSIGHTS: Insight[] = [
  {
    ...
    affectedResources: [{ name: 'i-0abc123 (EC2)', cloud: 'aws' }, { name: 'db.t3.large (RDS)', cloud: 'aws' }, { name: 'acme-logs (S3)', cloud: 'aws' }],
    confidence: 92,
  ...
  },
  {
    ...
    affectedResources: [{ name: '/api/auth (WAF)', cloud: 'aws' }, { name: 'acme-prod-assets (S3)', cloud: 'aws' }],
    confidence: 98,
  ...
  },
  {
    ...
    affectedResources: [{ name: 'acme-cdn (CloudFront)', cloud: 'aws' }, { name: '/api/products endpoint', cloud: 'aws' }],
    confidence: 85,
  ...
  },
  {
    ...
    affectedResources: [{ name: 'marcus.webb (IAM)', cloud: 'aws' }, { name: 'priya.patel (IAM)', cloud: 'aws' }, { name: 'acme-storage-02 (Azure)', cloud: 'azure' }],
    confidence: 96,
  ...
  },
  {
    ...
    affectedResources: [{ name: 'East US VMs (3)', cloud: 'azure' }, { name: 'acme-logs (S3)', cloud: 'aws' }],
    confidence: 72,
