...
const RESOURCES: Resource[] = [
  ...
  { id: 'r5',  name: 'acme-prod-assets',   type: 'storage',  cloud: 'aws',   region: 'us-east-1', status: 'warning', cost: '$48/mo',  icon: HardDrive, cpu: 0,  memory: 0,  owner: 'Platform Team', environment: 'production', health: 'warning', tags: ['public','static'] },
  { id: 'r6',  name: 'acme-logs',          type: 'storage',  cloud: 'aws',   region: 'us-east-1', status: 'running', cost: '$32/mo',  icon: HardDrive, cpu: 0,  memory: 0,  owner: 'DevOps',        environment: 'production', health: 'healthy', tags: ['logs'] },
  { id: 'r7',  name: 'acme-cdn',           type: 'network',  cloud: 'aws',   region: 'Global',    status: 'running', cost: '$88/mo',  icon: Globe,     cpu: 0,  memory: 0,  owner: 'Platform Team', environment: 'production', health: 'warning', tags: ['cdn','global'] },
  ...
  { id: 'r10', name: 'acme-cosmos-prod',   type: 'database', cloud: 'azure', region: 'East US',   status: 'running', cost: '$125/mo', icon: Database,  cpu: 8,  memory: 22, owner: 'Data Team',     environment: 'production', health: 'healthy', tags: ['db','nosql'] },
  { id: 'r11', name: 'acme-storage-prod',  type: 'storage',  cloud: 'azure', region: 'East US',   status: 'running', cost: '$72/mo',  icon: HardDrive, cpu: 0,  memory: 0,  owner: 'DevOps',        environment: 'production', health: 'healthy', tags: ['storage'] },
  { id: 'r12', name: 'acme-fn-api',        type: 'compute',  cloud: 'azure', region: 'East US',   status: 'stopped', cost: '$0/mo',   icon: Server,    cpu: 0,  memory: 0,  owner: 'Dev Team',      environment: 'dev',        health: 'critical', tags: ['functions','dev'] },
];
