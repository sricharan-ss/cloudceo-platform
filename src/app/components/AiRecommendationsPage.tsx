...
const RECS: Recommendation[] = [
  ...
  { id: 'r5',  category: 'security',    priority: 'high',     cloud: 'aws',   title: 'S3 bucket public access not fully blocked', description: 'Bucket "cloudceo-prod-assets" has a policy allowing s3:GetObject from *. Confirm this is intentional or restrict immediately.',   impact: 'Potential data exposure',savings: undefined,  effort: 'low',    status: 'open' },
